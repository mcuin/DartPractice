...
void updateBadge(Event e) {
  ...
  if (inputName.trim().isEmpty) {
    genButton..disabled = false..text = "Aye! Gimmie a name!";
  } else {
    genButton..disabled = true..text = "Arrr! Write yer name!";
  }
}
...
class PirateName {
  ...
  PirateName({String firstName, String appellation}) {
    ...
    if (appellation == null) {
      _appellation = appellations[indexGen.nextInt(names.length)];
    } else {
